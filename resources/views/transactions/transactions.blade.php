						...
						<div class="card">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									{{-- <a href="{{ route('transactions.create') }}" class="btn btn-outline-primary btn-block">إضافة معاملة جديدة</a> --}}
								</div>
							</div>
							<div class="card-body">
									...
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												...
												<th class="wd-20p border-bottom-0">إلى</th>
