							...
							<div class="main-profile-overview">
								<div class="main-img-user profile-user">
									@if($profile->photo != null)
										<img alt="" src="{{URL::asset($profile->photo)}}"><span class="avatar-status profile-status bg-green"></span>
									@else
										<img alt="" src="{{URL::asset('assets/img/faces/6.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
									@endif
								</div>
								<div class="d-flex justify-content-between mg-b-20">
									<div>
										<h5 class="main-profile-name">{{$profile->username}}</h5>
										<p class="main-profile-name-text">{{$profile->email}}</p>
									</div>
								</div>
								<h6>Bio</h6>
