...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">المستخدمين</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تفاصيل المستخدمين</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
								...
								<div class="pl-0">
									<div class="main-profile-overview">
										<div class="main-img-user profile-user">
											@if($user->photo != null)
											<img alt="" src="{{URL::to($user->photo)}}"><a class="fas fa-camera profile-edit" href="JavaScript:void(0);"></a>
											@else
